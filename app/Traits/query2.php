<?php
    function queryBookings($query, $query2, $queryData){
        $bookings = DB::select("SELECT 
                                ...
                                GROUP_CONCAT(DISTINCT it.service_type ORDER BY it.service_type ASC SEPARATOR ',') AS service_types,
                            ...
                            FROM reservations as rez
                                ...
                                LEFT JOIN (
                                    ...
                                    -- JOIN para datos de transportación
                                    LEFT JOIN (
                                ...
                                -- JOINs para tabla de items de reservacion (MODIFICADO)
                                LEFT JOIN (
                                    SELECT  
                                        it.reservation_id, 
                                        it.is_round_trip,
                                        ...
                                        -- NUEVO: Determinar el tipo de servicio para cada item
                                        GROUP_CONCAT(
                                            DISTINCT 
                                            CASE 
