...
trait QueryTrait2
{
     ...
     */
    public function queryRefunds2($query, $query2, $queryData){
        //Cache::forget('refunds_' . md5(json_encode($queryData)));
        $cacheKey = 'refunds_' . md5(json_encode($queryData));
        // echo $cacheKey;

        return Cache::remember($cacheKey, now()->addMinutes(30), function () use ($query, $query2, $queryData) {
