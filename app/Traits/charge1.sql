...
WHERE rez.site_id NOT IN(21,11) 
  AND rez.created_at BETWEEN '2024-12-01 00:00:00' AND '2024-12-31 23:59:59'
  AND p.paypal_conciliated + p.paypal_not_conciliated > 0
