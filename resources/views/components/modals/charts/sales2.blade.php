                ...
                <div class="container_left">
                    @if ( isset($bookingsStatus) )
                        <div id="chartStatus">                            
                            <div>
                                <div>
                                    <canvas class="chartSale" id="chartSaleStatus2" style="max-width: 100%; max-height: 400px;"></canvas>
                                </div>
                                <div>
                                    <h6>Por Estatus</h6>
                    ...
                    @if ( isset($dataMethodPayments) )
                        <div id="chartMethodPayments">                            
                            <div>
                                <div>
                                    <canvas class="chartSale" id="chartSaleMethodPayments2" style="max-width: 100%; max-height: 400px;"></canvas>
                                </div>
                                <div>
                    ...
                    @if ( isset($dataCurrency) )
                        <div id="chartCurrency">                            
                            <div>
                                <div>
                                    <canvas class="chartSale" id="chartSaleCurrency2" style="max-width: 100%; max-height: 400px;"></canvas>
                                </div>
                                <div>
                                    <h6>Por Moneda</h6>                                
                                    <div class="table-responsive">
                    ...
                    @if ( isset($dataVehicles) )
                        <div id="chartVehicle">                            
                            <div>
                                <div>
                                    <canvas class="chartSale" id="chartSaleVehicle2" style="max-width: 100%; max-height: 400px;"></canvas>
                                </div>
                                <div>
                                    <h6>Por Vehículo</h6>                                
                                    <div class="table-responsive">
                    ...
                    @if ( isset($dataServiceTypeOperation) )
                        <div id="chartServiceType">                            
                            <div>
                                <div>
                                    <canvas class="chartSale" id="chartSaleServiceType2" style="max-width: 100%; max-height: 400px;"></canvas>
                                </div>
                                <div>
