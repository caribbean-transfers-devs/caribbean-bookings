            ...
            <form class="form" action="" method="POST" id="formSearch">
                <div class="modal-body">
                    ...
                    <div class="top">
                        <div class="item">
                            <div class="box_input transparent">
                                ...
                                <svg width="24" height="24"><use xlink:href="{{ asset('/assets/img/icons/icons.svg#dropwtop') }}"></use></svg>
                            </div>
                        </div>
                        <div class="item">                            
                            @if ( isset($isSearch) )
                                <div class="box_input transparent_border">
                                    <svg width="24" height="24"><use xlink:href="{{ asset('/assets/img/icons/icons.svg#modal') }}"></use></svg>
                                    <div class="input">
                                        <label class="form-label" for="filter_text">Buscar por:</label>
                    ...
                    <div class="row bottom">
                        ...
                        @if ( !empty($methods) )
                            <div class="col-lg-4 col-md-6 col-12">
                                <select class="form-control selectpicker" title="Metodo de pago de reservación" data-live-search="true" data-selected-text-format="count > 2" name="payment_method[]" id="payment_method" data-value="{{ json_encode($data['payment_method']) }}" multiple data-actions-box="true">
                        ...
                        @if ( isset($isduplicated) )
                            <div class="col-lg-4 col-md-6 col-12">
                                <select class="form-control selectpicker" title="Mostrar reservas duplicadas" name="is_duplicated" id="is_duplicated">
                                    <option value="">Selecciona una opción</option>
