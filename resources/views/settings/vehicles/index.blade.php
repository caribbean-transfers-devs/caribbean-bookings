...
@push('Css')
    <link href="{{ mix('/assets/css/sections/settings/vehicles.min.css') }}" rel="preload" as="style" >
    <link href="{{ mix('/assets/css/sections/settings/vehicles.min.css') }}" rel="stylesheet" > 
@endpush
