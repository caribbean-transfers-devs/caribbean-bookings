                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <div class="section general-info">
                        <div class="info">
                            ...
                            <form action="{{ !isset($zone) ? route('enterprises.zones.store', [( isset($enterprise->id) ? $enterprise->id : 0 )]) : route('enterprises.sites.update', [( isset($zone->id) ? $zone->id : 0 )]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if ( isset($zone) )
                                    @method('PUT')
                                @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_primary" id="is_primary" class="form-control mb-3">
                                                ...
                                                <option {{ old('is_primary', $zone->is_primary ?? '') == '0' ? 'selected' : 'selected' }} value="0">No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control mb-3">
                                                ...
                                                <option {{ old('status', $zone->status ?? '') == '1' ? 'selected' : 'selected' }} value="1">Sí</option>
                                            </select>
                                        </div>
                                    </div>
