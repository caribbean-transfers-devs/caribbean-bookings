                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <div class="section general-info">
                        <div class="info">
                            ...
                            <form action="{{ !isset($rate) ? route('enterprises.rates.store', [( isset($enterprise->id) ? $enterprise->id : 0 )]) : route('enterprises.rates.update', [( isset($rate->id) ? $rate->id : 0 )]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if ( isset($rate) )
                                    @method('PUT')
                                @endif
                                {{-- @dump($rate->toArray()); --}}
                                <input type="hidden" name="enterprise_id" class="form-control" id="enterpriseID" value="{{ isset($enterprise->id) ? $enterprise->id : $rate->enterprise_id }}">
                                ...
                                <div class="row">                                            
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        <a class="btn btn-danger" href="{{ route('enterprises.rates.index', [( isset($enterprise->id) ? $enterprise->id : $rate->enterprise_id )]) }}">Cancelar</a>
