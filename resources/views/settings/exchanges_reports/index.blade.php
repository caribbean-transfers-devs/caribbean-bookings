...
@push('Css')
    <link href="{{ mix('/assets/css/sections/settings/exchanges_reports.min.css') }}" rel="preload" as="style" >
    <link href="{{ mix('/assets/css/sections/settings/exchanges_reports.min.css') }}" rel="stylesheet" >
@endpush
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-3">
                                        <a class="btn btn-primary" href="{{ route('exchanges.edit', [$exchange->id]) }}">Editar</a>
