<div class="col-xl-12 col-lg-12 col-md-12  mb-3">
    <a href="javascript:void(0);" onclick="getSpamByStatus('CONFIRMED','{{ $date }}')">
...
<div class="col-xl-3 col-lg-3 col-md-3 mb-3">
    <a href="javascript:void(0);" onclick="getSpamByStatus('PENDING','{{ $date }}')">
...
<div class="col-xl-3 col-lg-3 col-md-3  mb-3">
    <a href="javascript:void(0);" onclick="getSpamByStatus('SENT','{{ $date }}')">
...
<div class="col-xl-3 col-lg-3 col-md-3  mb-3">
    <a href="javascript:void(0);" onclick="getSpamByStatus('LATER','{{ $date }}')">
...
<div class="col-xl-3 col-lg-3 col-md-3  mb-3">
    <a href="javascript:void(0);" onclick="getSpamByStatus('REJECTED','{{ $date }}')">
