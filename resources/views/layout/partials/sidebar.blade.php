    ...
    @php
        ...
        if(RoleTrait::hasPermission(43) || RoleTrait::hasPermission(44) || RoleTrait::hasPermission(45) || RoleTrait::hasPermission(50) || RoleTrait::hasPermission(71) || RoleTrait::hasPermission(97) || RoleTrait::hasPermission(98)):
            ...
            array_push($links,[
                ...
                'name' => 'Reportes',
                'route' => null,
                'active' => request()->routeIs('reports.payment','reports.payment.action','reports.sales','reports.sales.action','reports.commissions','reports.commissions.action','reports.cash','reports.cash.action','reports.reservations','reports.reservations.action','reports.operations','reports.operations.action','reports.conciliation','reports.conciliation.action'),
                'urls' => $links_reports
            ]);
        endif;
