...
let setup = {
    ...
    */
    actionTable: function(table, param = ""){
        ...
        _settings.dom = `<'dt--top-section'<'row'<'col-12 col-sm-9 d-flex justify-content-sm-start justify-content-center'l<'dt--pages-count align-self-center'i><'dt-action-buttons align-self-center ms-3'B>><'col-12 col-sm-3 d-flex justify-content-sm-end justify-content-center mt-sm-0 mt-3'f>>>
                        <''tr>
