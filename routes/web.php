...
Route::group(['middleware' => ['auth', 'Debug']], function () {
    ...
    //BOTS
        ...
        Route::match(['post'],  '/stripe-internal/stripe-temporal-semi-automatic-conciliation',      [CONCILIATION::class, 'stripeTemporalSemiAutomaticConciliation'])->name('stripe.internal.semi_automatic_conciliation')->withoutMiddleware(['auth']);
        Route::match(['post'],  '/stripe-internal/stripe-temporal-confirm-automatic-conciliation',   [CONCILIATION::class, 'stripeTemporalConfirmAutomaticConciliation'])->name('stripe.internal.confirm_automatic_conciliation')->withoutMiddleware(['auth']);
