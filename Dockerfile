...
# Linux
#`docker run --name caribbean-bookings -p 1038:80 -v $(pwd):/var/www/html -d laravel-php8.1:latest`
# Windows
#`docker run --name caribbean-bookings -p 3062:80 -v "$(pwd):/var/www/html" -d laravel-php8.1:latest`
# En windows, si el pwd da problemas, ejecutar en consola pwd y copiar el path que genera, reemplazarlo por $(pwd)
# Ejemplo docker run --name caribbean-bookings -p 1038:80 -v "/c/laragon/www/eTransfer/laravel-etransfers:/var/www/html" -d laravel-php8.1:latest
