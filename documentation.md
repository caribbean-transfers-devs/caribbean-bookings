...
<!-- Cambiar título de desposorio de stripe a depósito de banco  -->

<!-- Generar un nuevo botón en detalle de reserva para generar link de pago con Santander  -->
...
Estatus de no operado

Choose Region: New York
DataCenter: Datacenter 3 -NYC3
Choose an image: Ubuntu 24.04 (LTS) x64
Choose Size:
Droplet Type: Shared CPU Basic (Plan selected)
...
permiso, para poder abrir los horarios cuando los chicos se equivoquen